...
The diagram below details the individual steps of this workflow.
...
Reshaping data is a very common step you may need complete in order to manipulate your data into form that can be incorporated into your analysis. The _shape_ of the data refers to whether the data is in a _long_ format or _wide_ format. Wide format is often used when analyzing data, performing calculations, or manual data entry. It’s intuitive for reading and interpreting data. 
