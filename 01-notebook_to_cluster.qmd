...
What happens when your data grow too large for your laptop? That was the question that gave rise to this project we call _"From the Notebook to the Cluster"_. 
...
This project describes the *Penguin Research Project* (PRP).  PRP's goal is to expand on the initial observations done by Dr. Gorman's in 2007.
...
However, when the data start to increase in orders of magnitude or the computing needs of one's analyses start to require hours needed to run, it might be advisable to look for resources with larger compute. 
...
This involved storage that you physically connect to your machine. Typicall you have two options: harddrives permanently connected to your device and removable storage such as external hard drives and USB-drives. 
